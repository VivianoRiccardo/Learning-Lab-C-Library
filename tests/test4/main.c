...
int main(){
    ...
    fcls[0] = fully_connected(rls[0]->channels*rls[0]->input_rows*rls[0]->input_cols,middle_neurons,3,NO_DROPOUT,SIGMOID,0);
    fcls[1] = fully_connected(middle_neurons,output_dimension,4,NO_DROPOUT,SOFTMAX,0);
