...
int main(){
    ...
    fcls[1] = fully_connected(middle_neurons,2*output_dimension,6,NO_DROPOUT,SIGMOID,0);
    ...
    dfcls[0] = fully_connected(output_dimension,middle_neurons,0,NO_DROPOUT,RELU,0);
    dfcls[1] = fully_connected(middle_neurons,drls[0]->channels*drls[0]->input_rows*drls[0]->input_cols,1,NO_DROPOUT,RELU,0);
    dfcls[2] = fully_connected(56*20*56,1*28*28,6,NO_DROPOUT,SIGMOID,0);
