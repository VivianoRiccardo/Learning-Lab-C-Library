...
int main(){
    ...
    fcls[0] = fully_connected(cls[0]->rows2*cls[0]->cols2*cls[0]->n_kernels,middle_neurons,1,NO_DROPOUT,SIGMOID,0);
    fcls[1] = fully_connected(middle_neurons,output_dimension,2,NO_DROPOUT,SOFTMAX,0);
